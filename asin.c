...
static const yytype_uint16 yyrline[] =
{
     ...
     115,   129,   136,   145,   144,   150,   158,   159,   169,   173,
     174,   196,   197,   221,   222,   250,   251,   274,   275,   310,
     311,   343,   361,   362,   376,   393,   403,   414,   415,   416,
...
#line 108 "src/asin.y" /* yacc.c:1646  */
    { 	SIMB s = obtenerTDS((yyvsp[-3].ident));
		...
		else if ( (!(s.tipo == (yyvsp[-1].exp).tipo && s.tipo == T_ENTERO)||!(s.tipo == (yyvsp[-1].exp).tipo && s.tipo == T_LOGICO)) )
...
#line 151 "src/asin.y" /* yacc.c:1646  */
    {
		{ if ((yyvsp[-4].exp).tipo != T_ERROR && (yyvsp[-4].exp).tipo != T_LOGICO)
...
#line 1615 "asin.c" /* yacc.c:1646  */
  ...
  case 37:
#line 274 "src/asin.y" /* yacc.c:1646  */
    { (yyval.exp).tipo = (yyvsp[0].exp).tipo; (yyval.exp).valor = (yyvsp[0].exp).valor; (yyval.exp).valid = (yyvsp[0].exp).valid; }
...
#line 1807 "asin.c" /* yacc.c:1646  */
  ...
  case 50:
#line 420 "src/asin.y" /* yacc.c:1646  */
    { (yyval.cent) = OP_ASIG;}
...
#line 466 "src/asin.y" /* yacc.c:1906  */
